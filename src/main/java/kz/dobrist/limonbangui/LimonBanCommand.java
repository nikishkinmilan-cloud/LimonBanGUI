...
public class LimonBanCommand implements CommandExecutor, TabCompleter {
    ...
    public LimonBanCommand(LimonBanGUI plugin, BanManager banManager, CheckRoomManager checkRoomManager) {
        this.plugin = plugin;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (args.length == 0) {
            sender.sendMessage("Использование: /limonban reload | unban <ник> | room set | room tp <ник> | room return <ник>");
            return true;
        }
        ...
        switch (args[0].toLowerCase()) {
            ...
            default -> sender.sendMessage("Неизвестная подкоманда. Использование: /limonban reload | unban <ник> | room set | room tp <ник> | room return <ник>");
        }
        return true;
    }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        if (args.length == 1) return List.of("reload", "unban", "room");
